...
#include "Model/ModelControls.h"
#include "PTAMTracking/MGButton.h"
...
/*
 * Edit by Umakatsu 2012.3.3
 */
void Resave_3ds_cb( ModelsGameData & data)
{
...
//  pButton->Init( irNextPos, ImageRef(40,40), DeleteAllModels_cb, "ARData/Overlays/delete_all.png", "ARData/Overlays/delete_all.png");
  pButton = new MGButton( "re-save current model" );
  pButton->Init( irNextPos, ImageRef(40,40), Resave_3ds_cb, "ARData/Overlays/Save.png", "ARData/Overlays/Save.png");
  mvButtons.push_back( pButton );
