...
#include "TextureTransfer/main_TextureTransfer.h"
...
namespace PTAMM {
	...
	void System::GUICommandCallBack(void *ptr, string sCommand, string sParams) {
		...
		// Added by Umakatsu
			...
			if( static_cast<System *> (ptr)->bgraph){
				cerr << "Segmentation is running already!!" << endl;
				return;
			}
			...
			static_cast<System *> (ptr)->strokes.clear();
			static_cast<System *> (ptr)->bStartSCM = ~static_cast<System *> (ptr)->bStartSCM;
		}
	...
	//	}
		cerr << "No class [MapSerializer]. if you want to use, you should include in it" << endl;
	}
