...
static const char fragmentShaderSource_withBaseTexture[] = 
	...
	"		gl_FragColor = color;\n"
	"	 } else { \n"
	"		gl_FragColor = shadow2DProj( osgShadow_shadowTexture, gl_TexCoord[1] ) * osgShadow_ambientBias.y; \n"
	"	 } \n"
	"}\n";
...
MyShadowMap::MyShadowMap(const MyShadowMap& copy, const osg::CopyOp& copyop):
...
void MyShadowMap::setTextureUnit(unsigned int unit)
{
    _shadowTextureUnit = unit;
}

void MyShadowMap::setPolygonOffset(const osg::Vec2& polyOffset)
{
    _polyOffset = polyOffset;
}

void MyShadowMap::setAmbientBias(const osg::Vec2& ambientBias)
{
...
void MyShadowMap::setTextureSize(const osg::Vec2s& textureSize)
{
    _textureSize = textureSize;
    dirty();
}

void MyShadowMap::setLight(osg::Light* light)
{
    _light = light;
}


void MyShadowMap::setLight(osg::LightSource* ls)
{
    _ls = ls;
    _light = _ls->getLight();
}

void MyShadowMap::createUniforms()
{
    _uniformList.clear();
...
void MyShadowMap::createShaders()
{
...
void MyShadowMap::update(osg::NodeVisitor& nv)
{
    _shadowedScene->osg::Group::traverse(nv);
}

void MyShadowMap::cull(osgUtil::CullVisitor& cv)
{
    ...
    if (selectLight)
    {
        ...
        //std::cout<<"----- VxOSG::MyShadowMap selectLight spot cutoff "<<selectLight->getSpotCutoff()<<std::endl;
...
void MyShadowMap::cleanSceneGraph()
{
}
...
////////////////////////////////////////////////////////////////////////////////
class MyShadowMap::DrawableDrawWithDepthShadowComparisonOffCallback: 
...
////////////////////////////////////////////////////////////////////////////////
osg::ref_ptr<osg::Camera> MyShadowMap::makeDebugHUD()
{
