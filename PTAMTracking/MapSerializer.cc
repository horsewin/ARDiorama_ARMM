...
//#include "PTAMTracking/MD5Wrapper.h"
...
//  {
//    cerr << "ERROR: the PTAMTracking/MD5.hash of " << sImgFileName << " does not match the one in xml file" << endl;
...
//
//    //save a PTAMTracking/MD5.hash of the image data to ensure the same data is loaded
//    MD5Wrapper md5w;
//    string sMD5;
