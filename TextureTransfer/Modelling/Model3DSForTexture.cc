#include "TextureTransfer/Modelling/Model3DSForTexture.h"
#include "OpenGL.h"
 ...
 * Constructor
 */
Model3DSForTexture::Model3DSForTexture() :
 ...
 * @return success
 */
bool Model3DSForTexture::Load(std::string sModelDir, std::string sFileName, TooN::Vector<
		3> v3Rotation) {
 ...
 */
GLuint Model3DSForTexture::_GenerateDisplayList(Lib3dsFile * pModel, bool bWireframe) {
	assert( pModel );
...
GLuint Model3DSForTexture::_GenerateDisplayList(Lib3dsFile * pModel, bool bWireframe, std::deque<Texture *> texturesList)
{
	assert( pModel );
 ...
 */
void Model3DSForTexture::ScaleIncrease() {
	mdScaleMult -= 0.04;
 ...
 */
void Model3DSForTexture::ScaleDecrease() {
	mdScaleMult += 0.1;
	mdScale = exp(-mdScaleMult);
}
 ...
 * Move forwards
 */
void Model3DSForTexture::MoveForwards() {
 ...
 * Move backwards
 */
void Model3DSForTexture::MoveBack() {
	double inc = GV3::get<double>("ModelsGame.MoveIncrement", "0.01", SILENT
			| HIDDEN);
 ...
 * Move to the left
 */
void Model3DSForTexture::MoveLeft() {
	double inc = GV3::get<double>("ModelsGame.MoveIncrement", "0.01", SILENT
			| HIDDEN);
 ...
 * move to the right
 */
void Model3DSForTexture::MoveRight() {
	double inc = GV3::get<double>("ModelsGame.MoveIncrement", "0.01", SILENT
			| HIDDEN);
	mse3MfromW.get_translation() += mse3MfromW.get_rotation() * makeVector(0,
			-inc, 0);
 ...
 * move up
 */
void Model3DSForTexture::MoveUp() {
	double inc = GV3::get<double>("ModelsGame.MoveIncrement", "0.01", SILENT
			| HIDDEN);
	mse3MfromW.get_translation() += mse3MfromW.get_rotation() * makeVector(0,
			0, inc);
 ...
 * Move down
 */
void Model3DSForTexture::MoveDown() {
	double inc = GV3::get<double>("ModelsGame.MoveIncrement", "0.01", SILENT
			| HIDDEN);
	mse3MfromW.get_translation() += mse3MfromW.get_rotation() * makeVector(0,
			0, -inc);
 ...
 */
void Model3DSForTexture::PitchIncrease() {
 ...
 */
void Model3DSForTexture::PitchDecrease() {
	double inc = GV3::get<double>("ModelsGame.RotateIncrement", "1.0", SILENT
			| HIDDEN) * M_PI / 180;
	Vector<3> rot = makeVector(0.0, -inc, 0.0);
	mse3MfromW.get_rotation() *= SO3<>::exp(rot);
 ...
 */
void Model3DSForTexture::RollIncrease() {
	double inc = GV3::get<double>("ModelsGame.RotateIncrement", "1.0", SILENT
			| HIDDEN) * M_PI / 180;
 ...
 */
void Model3DSForTexture::RollDecrease() {
	double inc = GV3::get<double>("ModelsGame.RotateIncrement", "1.0", SILENT
			| HIDDEN) * M_PI / 180;
	Vector<3> rot = makeVector(-inc, 0.0, 0.0);
	mse3MfromW.get_rotation() *= SO3<>::exp(rot);
 ...
 */
void Model3DSForTexture::YawIncrease() {
	double inc = GV3::get<double>("ModelsGame.RotateIncrement", "1.0", SILENT
			| HIDDEN) * M_PI / 180;
 ...
 */
void Model3DSForTexture::YawDecrease() {
	double inc = GV3::get<double>("ModelsGame.RotateIncrement", "1.0", SILENT
			| HIDDEN) * M_PI / 180;
	Vector<3> rot = makeVector(0.0, 0.0, -inc);
	mse3MfromW.get_rotation() *= SO3<>::exp(rot);
 ...
 */
void Model3DSForTexture::MoveTo(Vector<3> v3Position) {
 ...
 * Draw the model axes
 */
void Model3DSForTexture::_DrawAxes() {
	float w = 0;
 ...
 */
void Model3DSForTexture::_FindBoundingBox(Lib3dsFile * pModel) {
	assert( pModel );
 ...
 */
void Model3DSForTexture::_DrawBoundingBox() {
 ...
 */
void Model3DSForTexture::_DelayedLoad() {
	if (mbDelayedLoad) {
		_Load();
		mbDelayedLoad = false;
	}
 ...
 * @param pModel the lib3ds model file
 */
deque<Texture *> Model3DSForTexture::_LoadTextures(Lib3dsFile * pModel, string dirpath) {
	assert( pModel );
